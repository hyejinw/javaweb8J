...
public class StoreGoodCommand implements StoreInterface {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 글 좋아요 1회 증가시키기("'StoreReplyGood'+고유번호" 값을 객체배열(ArrayList)에 담았다.)
		...
		String imsiGoodIdx = "StoreReplyGood" + idx;
		...
		Kn_StoreVO vo = dao.getStoreContent(storeIdx);
		request.setAttribute("vo", vo);
		
		// 메뉴에 달린 댓글들
		ArrayList<Kn_StoreReplyVO> replyVos = dao.getStoreReply(storeIdx);
