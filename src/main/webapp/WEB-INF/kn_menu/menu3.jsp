		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <div class="navbar-nav mr-auto">
					...
					<div class="pill-nav" style="margin-left:100px">
					  <a class="<c:if test="${part=='전체'}">active</c:if> mr-2" href="${ctp}/Menu.kn_menu?pageSize=${pageSize}&pag=1&part=전체">전체</a>
					  <a class="<c:if test="${part=='도넛'}">active</c:if> mr-2" href="${ctp}/Menu.kn_menu?pageSize=${pageSize}&pag=1&part=도넛">도넛</a>
