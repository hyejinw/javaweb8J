	...
	<h2 class="text-center" style="margin:0px auto;">로그인</h2>
		<form name="myform" method="post" action="${ctp}/LoginOk.kn_mem" style="margin-top:50px">
			<div class="form-group" style="margin:0px auto; padding-top:50px; width:60%"> <!-- 이 부분 추후에 반응형 사이즈로 재조절 필요 -->
				...
				<input type="checkbox" class="checkbox" checked id="remember_me"><label for="remember_me">Remember me</label>
					<div class="col-md-2 text-right p-0"><input type="checkbox" name="idSave" id="remember_me" class="checkbox" checked /><label for="remember_me"></label></div>
