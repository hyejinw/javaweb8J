...
<div class="container-xl p-5 my-5"  id="top">	
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" maxlength=20 id="pwd1" onchange="pwd1Check()" placeholder="비밀번호를 입력하세요." name="pwd1" required />
      <div id="pwdError" class="text-primary"></div>
    </div>
    <div class="form-group">
      <label for="pwd2">비밀번호 확인 <span class="must">*</span></label>
      <input type="password" class="form-control" maxlength=20 id="pwd2" onchange="pwd2Check()" placeholder="비밀번호를 입력하세요." required />
      <div id="pwdError2" class="text-primary"></div>
    </div>
    <div class="form-group">
      <label for="name">성명 <span class="must">*</span></label>
      <input type="text" class="form-control" id="name" onchange="nameCheck()" placeholder="성명을 입력하세요." name="name" required />
