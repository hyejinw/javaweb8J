...
<head>
	...
	<title>adminMenuInsert.jsp</title>
...
<body>
	<div id="c">
		<div style="text-align:center"><span class="text-center" style="font-size:40px; text-align:center; font-weight:500">메뉴 등록</span></div>
    ...
    <form name="menuInsert" method="post" action="${ctp}/AdminMenuInsertOk.kn_ad" enctype="multipart/form-data" style="width:90%; margin:0px auto; padding:20px 50px" class="border">
			...
			<div class="row mb-3">
				<div class="col-sm-4 head">가격</div>
				<div class="col-sm-8"><input type="number" name="price" id="price" class="form-control"/></div>
			</div>
			<div class="row mb-3">
				<div class="col-sm-4 head">설명</div>
				<div class="col-sm-8"><textarea cols="100" name="explanation" id="explanation" class="form-control"></textarea></div>
			</div>
			<div class="row mb-3">
				<div class="col-sm-4 head">알레르기 유발 요인</div>
				<div class="col-sm-8"><textarea cols="100" name="allergy" id="allergy" class="form-control"></textarea></div>
			</div>
			<div class="row mb-3">
				<div class="col-sm-4 head">원산지 정보</div>
				<div class="col-sm-8"><textarea cols="100" name="origin" id="origin" class="form-control"></textarea></div>
			</div>
			<div class="row mb-3">
				<div class="col-sm-4 head">메뉴 사진</div>
				<div class="col-sm-8"><input type="file" name="menuPhoto" id="menuPhoto" onchange="imgCheck(this)" class="form-control-file border form-control"/></div>
			</div>
			<div class="row mb-4">
